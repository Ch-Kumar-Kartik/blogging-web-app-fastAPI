...
@pytest.mark.anyio
async def test_home_renders_posts_without_changing_pagination_contract(
    client: AsyncClient,
):
    ...
    create_response = await client.post(
        "/api/posts",
        json={"title": "Visible post", "content": "Home page content"},
    ...
    assert "postsContainer" in response.text
